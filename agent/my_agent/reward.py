...
REWARDS = {
    ...
    "agent_death":     -2.0,   # Self-elimination
    "time_penalty":    -0.005, # Every step to encourage speed
    "standing_still":  -0.01,  # Penalise camping
    "plant_near_box":   0.08,  # Place bomb adjacent to a box
    "item_collection":  0.15,  # Pick up an item
    "danger_evasion":   0.12,  # Step out of blast zone
