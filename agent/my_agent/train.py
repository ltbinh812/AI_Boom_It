...
from agent import TrainingAgent, ReplayBuffer, encode_obs, NUM_ACTIONS, MAP_CHANNELS, AUX_DIM
from reward import compute_reward
from utils import seed_everything, save_checkpoint, plot_loss, plot_rewards, plot_win_rates, plot_epsilon
...
def _load_root_agent_module():
    """Load the root-level agent/__init__.py without shadowing our local 'agent'."""
    init_path = _ROOT / "agent" / "__init__.py"
    spec = _ilu.spec_from_file_location("_root_agent", str(init_path))
